...
| "need exactly one instance / shared coordinator" | [Singleton](01-creational-patterns.md#singleton) | One shared access point — but see the overuse trap below; also a thread-safety hazard, see [../06-concurrency-essentials.md](../06-concurrency-essentials.md) |
